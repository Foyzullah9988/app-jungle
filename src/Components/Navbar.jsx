                ...
                <div className="navbar-start ">
                    <div className="dropdown bg-base-300 rounded-xl">
                        ...
                        <ul 
                            ...
                            <li><NavLink to={'/'} className={dropActiveNav}>Home</NavLink></li>
                            <li><NavLink to={'/apps'} className={dropActiveNav}>Apps</NavLink></li>
                            <li><NavLink to={'/installation'} className={dropActiveNav}>Installation</NavLink></li>
                        </ul>
                    </div>
                    <Link to={'/'} className="btn btn-ghost text-2xl font-bold">
                        <img className='w-8' src="/src/assets/logo.png" alt="" />App     <h2 className='text-fuchsia-600'>Jungle</h2></Link>
                </div>
                <div className="navbar-center hidden lg:flex">
                    <ul className="menu menu-horizontal px-1">
                        <li><NavLink to={'/'} className={activeNav}>Home</NavLink></li>
                        <li><NavLink to={'/apps'} className={activeNav}>Apps</NavLink></li>
                        <li><NavLink to={'/installation'} className={activeNav}>Installation</NavLink></li>
                    </ul>
                </div>
